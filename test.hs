...
decreasingList prevnum
  | prevnum <= 1 = [(1.0, [])]
  | prevnum == 2
  = let dice_1 = increase (1 / 6) 1 (decreasingList 1) in
    let rest   = [(5/6, [])] 
    in dice_1 ++ rest
  | prevnum == 3
  -- [] [1] [2] [2, 1]
  = let dice_1 = increase (1 / 6) 1 (decreasingList 1) in
    let dice_2 = increase (1 / 6) 2 (decreasingList 2) in
    let rest   = [(4/6, [])] 
    in dice_1 ++ dice_2 ++ rest
  | prevnum == 4
  = let dice_1 = increase (1 / 6) 1 (decreasingList 1) in
    let dice_2 = increase (1 / 6) 2 (decreasingList 2) in
    let dice_3 = increase (1 / 6) 3 (decreasingList 3) in
    let   rest = [(3/6, [])] 
  ...
  = let dice_1 = increase (1 / 6) 1 (decreasingList 1) in
    let dice_2 = increase (1 / 6) 2 (decreasingList 2) in
    let dice_3 = increase (1 / 6) 3 (decreasingList 3) in
    let dice_4 = increase (1 / 6) 4 (decreasingList 4) in
    let   rest = [(2/6, [])] 
  ...
  = let dice_1 = increase (1 / 6) 1 (decreasingList 1) in
    ...
    let dice_3 = increase (1 / 6) 3 (decreasingList 3) in
    let dice_4 = increase (1 / 6) 4 (decreasingList 4) in
    let dice_5 = increase (1 / 6) 5 (decreasingList 5) in
    let dice_6 = [(1/6, [])] 
